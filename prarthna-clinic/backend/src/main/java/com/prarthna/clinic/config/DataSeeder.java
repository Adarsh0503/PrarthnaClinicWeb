...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedDoctors() {
        ...
        Doctor dr1 = Doctor.builder()
                ...
                .about("Dr. Paritosh Mishra is a senior physician with over 10 years of experience treating patients across Delhi NCR. Founder of Prarthna Clinic, he specialises in general medicine, diabetes management, and hypertension.")
                .experience(20)
                .ticketPrice(500.0)
                .averageRating(4.9)
                .totalRating(872)
