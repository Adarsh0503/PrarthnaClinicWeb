...
const values = [
  ...
  { icon: Users,   title: 'Community First',      desc: `Rooted in Tigri Colony since ${FOUNDED}, we serve the healthcare needs of our neighbourhood.` },
...
const doctors = [
  {
    ...
    img:  'https://prarthna-clinic-uploads.s3.ap-south-1.amazonaws.com/WhatsApp+Image+2026-03-23+at+23.45.37.jpeg',
    bio:  `With over 20 years of experience, Dr. Paritosh founded Prarthna Clinic to make quality healthcare accessible to every family.`,
    id:   1,
  },
  {
    name: 'Dr. Rajni Mishra',
    spec: 'BDS · Dental Specialist',
    img:  'https://prarthna-clinic-uploads.s3.ap-south-1.amazonaws.com/WhatsApp+Image+2026-03-23+at+23.46.16.jpeg',
    bio:  'Dr. Rajni brings 15+ years of dental expertise and is known for her gentle, patient-first approach to dental care.',
    id:   2,
  },
]
      ...
      <div className="bg-blue-800 py-20 px-6 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-white/70 text-lg max-w-2xl mx-auto">
            {YEARS}+ years of serving Delhi NCR families with expert, affordable, and compassionate multispeciality healthcare.
          </p>
        </div>
      </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="section-title">{YEARS}+ Years of Trusted Healthcare in the Heart of Delhi</h2>
            <p className="text-slate-500 leading-relaxed mb-5">
              Prarthna Multispeciality Clinic was founded in {FOUNDED} by Dr. Paritosh Mishra with a singular vision:
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -left-5 bg-blue-800 text-white rounded-2xl p-5 shadow-2xl">
              <div className="font-serif text-3xl font-bold text-blue-200">Est. {FOUNDED}</div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {doctors.map(({ name, spec, img, bio, id }) => (
              <div key={name} className="bg-white border border-blue-100 rounded-3xl overflow-hidden hover:shadow-xl transition-all">
                ...
                <div className="p-7">
                  ...
                  <Link href={`/booking?doctorId=${id}`} className="btn-primary inline-block text-sm">Book Appointment</Link>
                </div>
              </div>
            ))}
          </div>
